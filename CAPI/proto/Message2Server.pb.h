...
class MessageToServer final :
 ...
 public:
  ...
  ::PROTOBUF_NAMESPACE_ID::int64 timeinmilliseconds() const;
  void set_timeinmilliseconds(::PROTOBUF_NAMESPACE_ID::int64 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int64 _internal_timeinmilliseconds() const;
  void _internal_set_timeinmilliseconds(::PROTOBUF_NAMESPACE_ID::int64 value);
  public:
  ...
  // int32 gemSize = 7;
  void clear_gemsize();
  ::PROTOBUF_NAMESPACE_ID::int32 gemsize() const;
  void set_gemsize(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_gemsize() const;
  void _internal_set_gemsize(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::int64 timeinmilliseconds_;
  double angle_;
  ::PROTOBUF_NAMESPACE_ID::int64 toplayerid_;
  ::PROTOBUF_NAMESPACE_ID::int32 gemsize_;
  int pskill_;
  int askill1_;
  int askill2_;
...
inline ::PROTOBUF_NAMESPACE_ID::int64 MessageToServer::_internal_timeinmilliseconds() const {
  return timeinmilliseconds_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64 MessageToServer::timeinmilliseconds() const {
  // @@protoc_insertion_point(field_get:Protobuf.MessageToServer.timeInMilliseconds)
  return _internal_timeinmilliseconds();
}
inline void MessageToServer::_internal_set_timeinmilliseconds(::PROTOBUF_NAMESPACE_ID::int64 value) {
  
  timeinmilliseconds_ = value;
}
inline void MessageToServer::set_timeinmilliseconds(::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 MessageToServer::_internal_gemsize() const {
  return gemsize_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 MessageToServer::gemsize() const {
  // @@protoc_insertion_point(field_get:Protobuf.MessageToServer.gemSize)
  return _internal_gemsize();
}
inline void MessageToServer::_internal_set_gemsize(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  gemsize_ = value;
}
inline void MessageToServer::set_gemsize(::PROTOBUF_NAMESPACE_ID::int32 value) {
